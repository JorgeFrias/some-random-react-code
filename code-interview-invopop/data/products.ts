...
export const products: Product[] = [
    new Product("T-Shirt", "TSHIRT", 2000, Currency.EUR, "/img/shirt.png", "/img/shirt-full.png", loremIpsum),
    new Product("Coffee Mug", "MUG", 750, Currency.EUR, "/img/cup.png", "/img/shirt-full.png", loremIpsum),
    new Product("Cap", "CAP", 500, Currency.EUR, "/img/hat.png", "/img/shirt-full.png", loremIpsum)
];